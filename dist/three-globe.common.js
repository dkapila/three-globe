...
var GlobeLayerKapsule = Kapsule__default['default']({
  ...
  stateInit: function stateInit() {
    ...
    var graticulesObj = new THREE$5.LineSegments(new threeGeojsonGeometry.GeoJsonGeometry(d3Geo.geoGraticule10(), GLOBE_RADIUS, 2), new THREE$5.LineBasicMaterial({
      color: 'lightgrey',
      transparent: true,
      opacity: 0.1
    }));
...
var PointsLayerKapsule = Kapsule__default['default']({
  ...
  update: function update(state) {
    ...
    if (state.pointsMerge) {
      ...
      var pointsGeometry = !state.pointsData.length ? new THREE$4.BufferGeometry() : BufferGeometryUtils_js.BufferGeometryUtils.mergeBufferGeometries(state.pointsData.map(function (d) {
